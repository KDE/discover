...
Keywords[be]=праграма;праграмнае забеспячэнне;рэпазіторый;пакет;дадаць;усталяваць;выдаліць;абнавіць;праграмы;гульні;flatpak;snap;дапаўненні;прашыўка;
...
Keywords[el]=πρόγραμμα;λογισμικό;αποθετήριο;πακέτο;εγκατάσταση;απεγκατάσταση;αφαίρεση;ενημέρωση;εφαρμογές;παιχνίδια;flatpak;snap;πρόσθετα;firmware;
...
Keywords[eo]=programo;programaro;deponejo;pakaĵo;aldoni;instali;malinstali;forigi;ĝisdatigi;aplikaĵoj;aplikaĵoj;ludoj;flatpak;snap;aldonaĵoj;aldonaĵoj;firmvaro;
...
Keywords[fr]=programme ; logiciel ; dépôt ; paquet ; ajout ; installation ; désinstallation ; suppression ; mise à jour ; applications ; applications ; jeux ; flatpak ; snap ; modules externes ; micrologiciel ;
Keywords[gl]=aplicación;software;repositorio;paquete;empaquetar;engadir;instalar;desinstalar;retirar;actualizar;aplicativos;aplicacións;xogos;videoxogos;flatpak;snap;complementos;engadidos;extensións;firmware;
Keywords[he]=program;software;repository;package;install;remove;update;apps;applications;תוכנות;התקנה;הסרה;חבילה;מקורות;יישומים;תכנה;תוכנה;הסרת;אפליקציות;תוספות;משחקים;תוספים;הרחבות;קושחה;snap;flatpak;games;addons;add-ons;firmware;קשחה;
...
Keywords[ie]=programma;repositoria;paccage;adjunter;installar;deinstallar;actualisar;app;applicationes;ludes;flatpak;snap;addons;add-ons;firmware;
Keywords[is]=forrit;hugbúnaður;hugbúnaðarsafn;pakki;bæta við;setja upp;fjarlægja; fleygja;uppfæra;öpp;forrit;leikir;flatpak;snap;viðbætur;fastbúnaður;
...
Keywords[ta]=program;software;repository;package;add;install;uninstall;remove;update;apps;applications;games;flatpak;snap;addons;add-ons;firmware;மென்பொருள்;பயன்பாடு;செயலி;ஆப்ஸ்;ஆப்சு;நிரல்;கிடங்கு;களஞ்சியம்;தொகுப்பு;சேர்;நிறுவு;நிறுவல்;நீக்கு;புதுப்பி;புதுப்பித்தல்;ஃபலாட்பாக்;ஸ்னாப்;சுனாப்;செருகுநிரல்;துணை நிரல்கள்;துணைநிரல்;சாதனநிரல்;
Keywords[tr]=program;yazılım;depo;paket;ekle;kur;kaldır;güncelle;uygulama;uygulamalar;oyunlar;flatpak;snap;eklentiler;gömülü yazılım;donanım yazılımı;aygıt yazılımı;cihaz yazılımı;
