...
QtObject
{
    ...
    readonly property bool isCompact: (!root.mainWindow || compactMode!=MuonDiscoverMainWindow.Auto || root.mainWindow.phoneWindow.status != Component.Ready) ? compactMode==MuonDiscoverMainWindow.Compact : (width/root.mainWindow.Screen.pixelDensity<100)
