...
{
    if (!filter.resourceUrl.isEmpty() || (filter.category && filter.category.untranslatedName() != QLatin1String("Operating System"))) {
        return new ResultsStream(QStringLiteral("RpmOstreeStream-empty"), {});
    }
