...
SnapResource::SnapResource(QString name, bool isTechnical, AbstractResourcesBackend* parent)
...
QList<PackageState> SnapResource::addonsInformation()
{
    return m_addons;
}
...
{
    return { QStringLiteral("snap"), m_name.endsWith(QLatin1Char('3')) ? QStringLiteral("three") : QStringLiteral("notthree") };
}
...
{
    return QStringLiteral("SnapSource1");
}
...
void SnapResource::setAddons(const AddonList& addons)
{
...
void SnapResource::setAddonInstalled(const QString& addon, bool installed)
{
