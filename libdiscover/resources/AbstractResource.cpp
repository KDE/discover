...
QString AbstractResource::upgradeText() const
{
    ...
    if (installed == available) {
        ...
        return i18nc("@info 'Refresh' is used as a noun here. An app or runtime got updated without changing the user-facing version number %1", "Refresh of version %1", available);
